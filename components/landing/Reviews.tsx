...
export type ReviewItem = { text: string; name: string; meta: string };

const defaultReviews: ReviewItem[] = [
  {
    text: "Сделала пак — получилось настолько похоже, что даже родинка на щеке сохранилась. Друзья сразу узнали!",
    name: "Аня",
    meta: "2 пака",
  },
  {
    text: "Подарил девушке пак стикеров с нашими фото — лучший подарок на годовщину. Узнаваемо оба.",
    name: "Максим",
    meta: "3 пака",
  },
  {
    text: "Думала будет сложно, а тут просто фото отправила и через полминуты пак стикеров с разными эмоциями. Магия!",
    name: "Катя",
    meta: "1 пак",
  },
];
