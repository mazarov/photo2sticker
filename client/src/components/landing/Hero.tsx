...
const UTM_VARIANTS: {
  ...
  },
  {
    ...
    sub: "Выбери стиль и эмоции. ИИ сохранит твои черты. Первый пак бесплатно.",
  },
  {
    match: ["ai", "neural"],
  ...
  },
  {
    ...
    sub: "Пришли фото — получи пак с разными эмоциями. Узнаваемо ты. За 30 сек. Первый пак бесплатно.",
  },
];
